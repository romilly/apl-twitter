...
⍝ === End of variables definition ===
    ...
    ∇ Foo
      fxmb2←⊃##.DRC.X509Cert.ReadCertFromFile'c:\mystuff\source\congasvn\TestCertificates\kkc\fxmb2_org.pem'
      fxmb2.KeyOrigin←'DER' 'c:\mystuff\source\congasvn\TestCertificates\kkc\fxmb2_org.pem'
      fxmb2.IsCert
     
      fxmb1←⊃##.DRC.X509Cert.ReadCertFromFile'c:\mystuff\source\congasvn\TestCertificates\kkc\fxmb1.pem'
      fxmb1.KeyOrigin←'DER' 'c:\mystuff\source\congasvn\TestCertificates\kkc\fxmb1.pem'
      fxmb1.IsCert
      TestX509Certs
     
      ##.DRC.SetProp'.' 'Trace'(1536+8)
      z←fxmb2 32 'NONE:+VERS-TLS1.0:+AES-256-CBC:+AES-128-CBC:+RSA:+SHA1:+COMP-NULL:!CTYPE-OPENPGP'HTTPGet'https://127.0.0.1:4433'
      z←client 32 'NONE:+VERS-TLS1.0:+AES-256-CBC:+AES-128-CBC:+RSA:+SHA1:+COMP-NULL:!CTYPE-OPENPGP'HTTPGet'https://127.0.0.1:4433'
     
      z←fxmb2 32 'NONE:+VERS-TLS1.0:+AES-256-CBC:+AES-128-CBC:+RSA:+SHA1:+COMP-NULL:!CTYPE-OPENPGP'HTTPGet'https://127.0.0.1:5001'
      z←client 32 'NONE:+VERS-TLS1.0:+AES-256-CBC:+AES-128-CBC:+RSA:+SHA1:+COMP-NULL:!CTYPE-OPENPGP'HTTPGet'https://127.0.0.1:5001'
     
      z←fxmb2 32 'NONE:+VERS-TLS1.0:+AES-256-CBC:+AES-128-CBC:+RSA:+SHA1:+COMP-NULL:!CTYPE-OPENPGP'HTTPGet'https://193.203.229.143:443'
      z←client 32 'NONE:+VERS-TLS1.0:+AES-256-CBC:+AES-128-CBC:+RSA:+SHA1:+COMP-NULL:!CTYPE-OPENPGP'HTTPGet'https://193.203.229.143:443'
     
      z←fxmb2 32 'NORMAL:!CTYPE-OPENPGP'HTTPGet'https://193.203.229.143:443'
      ##.DRC.SetProp'.' 'Trace' 0
    ∇
    ...
    ∇ TestFTPClient;z;pub;CR;readme;host;user;pass;folder;file
     ⍝ Test the FTP Client
     
      CR←1⊃NL
      host user pass←'ftp.mirrorservice.org' 'anonymous' 'testing'
      folder file←'pub' 'readme.txt'
      ...
      :If 0≠1⊃pub←z.List folder
          ⎕←'Unable to list contens of folder: ',,⍕pub ⋄ →0
      :EndIf
      ...
      :If 0≠1⊃readme←z.Get'pub/readme.txt'
          ⎕←'File not found in folder ',folder,': ',file ⋄ →0
      :EndIf
     
      ⎕←folder,'/',file,' from ',host,':',CR
      ⎕←2⊃readme
    ∇
